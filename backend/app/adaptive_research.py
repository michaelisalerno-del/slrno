    ...
    for trial_index in range(budget):
        ...
        parameters = {
            **parameters,
            ...
            "contract_point_size": cost_profile.contract_point_size,
            "instrument_type": cost_profile.instrument_type,
            "share_spread_category": cost_profile.share_spread_category,
            "share_region": cost_profile.share_region,
