...
function GuideView({ setActiveModule }) {
  ...
  const repairs = [
    ...
    ["Multiple-testing haircut", "Use Evidence first for this template. Use cross-market checks as separate discovery, not as proof for the original."],
...
function autoRefinementPlanForTemplate(template, researchRun, enabledMarkets = [], activeMarketIds = []) {
  ...
  if (crossMarketDiscovery) {
    ...
    addStep("Use cross-market checks separately for discovery");
  }
  if (costStress) {
